        ...
        <div class="container">
            <div class="card shadow-sm border-0">
                <div class="card-header bg-brown border-bottom py-3 d-flex justify-content-between align-items-center">
                    <h5 class="card-title mb-0">Informasi Booking Disetujui</h5>
                ...
                <div class="card-body">
                    @if ($approvedBookings->isEmpty())
                        <div class="p-4 text-center">
                            <h5 class="mb-2">Belum Ada Booking Approved</h5>
                            <p class="text-muted mb-3">Saat ini belum ada jadwal booking yang disetujui.</p>
                                ...
                                <tbody>
                                    @foreach ($approvedBookings as $booking)
                                        <tr>
                                            ...
                                            <td>
                                                <span
                                                    class="badge text-bg-success text-uppercase">{{ $booking->status }}</span>
                                            </td>
                                        </tr>
                                    @endforeach
                                </tbody>
